...
class Edit extends \Magemonkeys\Taskmanager\Controller\Adminhtml\Tasks
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('magemonkeys_taskmanager_tasks', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Taskss'));
